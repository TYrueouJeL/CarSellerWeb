...
export const listRentableVehiclesValidator = vine.create({
...
export const createRentableVehicleValidator = vine.create({
    modelId: vine.number(),
    year: vine.number(),
    registration: vine.string().regex(/^[A-Z]{2}-\d{3}-[A-Z]{2}$/),
    mileage: vine.string(),
    dailyPrice: vine.string(),
});

export const updateRentableVehicleValidator = vine.create({
    modelId: vine.number().optional(),
    year: vine.number().optional(),
    registration: vine.string().regex(/^[A-Z]{2}-\d{3}-[A-Z]{2}$/).optional(),
    mileage: vine.string().optional(),
    dailyPrice: vine.string().optional(),
});
